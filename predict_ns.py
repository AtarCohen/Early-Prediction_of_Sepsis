...
class PreProcess():
    ...
    def __init__(self,df,window_size = 5, time_bm=-10, imputer_path = None):
        ...
        self.features = ['max_ICULOS', 'SBP__median', '5w_sum_BaseExcess__mean', 'Hct__min', 'Unit3__max', 'Hct__median', 'freq_Alkalinephos', 'freq_Phosphate', 'freq_WBC', '5w_sum_Lactate__mean', 'SOFA__max', 'freq_Fibrinogen', 'Lactate__mean', 'PTT__mean', 'SBP__min', 'O2Sat__mean', 'freq_Creatinine', 'O2Sat__std', 'freq_PaCO2', 'freq_SaO2', '5w_sum_PaCO2__mean', 'freq_pH', 'MAP__min', 'Temp__min', '5w_sum_Glucose__mean', '5w_sum_pH__mean', 'freq_TroponinI', 'freq_AST', 'freq_Magnesium', 'freq_Glucose', 'WBC__std', 'HospAdmTime__mean', 'freq_Platelets', '5w_sum_FiO2__mean', 'Hgb__mean', 'Gender', 'Unit1__max', 'Unit2__max', 'WBC__min', 'HCO3__mean', 'MAP__median', 'Age__mean', 'pH__std', 'freq_Hct', 'HR__std', 'FiO2__std', 'FiO2__mean', 'freq_BaseExcess', 'freq_Bilirubin_total', 'freq_Potassium', 'DBP__mean', 'freq_Lactate', 'freq_HCO3', 'freq_BUN', 'freq_Hgb', 'Resp__median', 'Resp__max', '5w_sum_PTT__mean', 'WBC__median', 'Magnesium__mean', 'Glucose__mean', 'Glucose__std', 'freq_Chloride', 'Potassium__mean', 'SBP__std', 'pH__median', 'freq_FiO2', 'Platelets__mean', 'Temp__mean', 'HR__median', 'freq_Bilirubin_direct', 'freq_Calcium', 'Resp__std', 'HR__max', 'BaseExcess__mean', 'freq_PTT', 'Phosphate__mean', 'AST__mean', 'SaO2__mean', 'TroponinI__mean', 'EtCO2__mean']
